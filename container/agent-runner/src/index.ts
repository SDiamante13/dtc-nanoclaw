...
async function runQuery(
  ...
  for await (const message of query({
    prompt: stream,
    options: {
      model: process.env.NANOCLAW_MODEL || 'claude-sonnet-4-5',
      cwd: '/workspace/group',
      ...
      allowedTools: [
        ...
        'mcp__google__google_auth_*',
        'mcp__google__calendar_*',
        'mcp__google__gmail_*',
        'mcp__google__slides_*',
        'mcp__google__tasks_*',
        'mcp__google__people_*',
        'mcp__google__forms_*',
        'mcp__google__chat_*',
        'mcp__google__youtube_*',
        'mcp__google__meet_*',
      ],
      env: sdkEnv,
